#ifndef IK_CONSTRAINT2_ORCONSTRAINT_H
#define IK_CONSTRAINT2_ORCONSTRAINT_H

#include <ik_constraint2/IKConstraint.h>
#include <iostream>

namespace ik_constraint2{
  class ORConstraint : public IKConstraint
  {
  public:
    //Childrenのどれか一つを満たす
    ...
    void copy(std::shared_ptr<ORConstraint> ret, const std::map<cnoid::BodyPtr, cnoid::BodyPtr>& modelMap) const;
